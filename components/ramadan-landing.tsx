...
const todayChecklist = [
  ...
  "Делай своё или бери нашу задачу — на твой выбор",
...
const faqItems = [
  ...
  },
  {
    ...
    answer: "Да, и это приветствуется. Своя идея, свой проект — всё окей. Наши задачи просто как вариант если нет идеи.",
  },
  {
      ...
      <main className="mx-auto w-full max-w-6xl px-4 pb-20 pt-8 sm:px-6 lg:px-8">
        ...
        <section className="mh-card animate-rise mt-8 p-6 md:p-8" style={{ animationDelay: "110ms" }}>
          ...
          <p className="mt-3 max-w-4xl text-base leading-relaxed text-zinc-700">
            Делай что хочешь — свой проект, свою идею, своего AI-ассистента.
            Брать нашу задачу не обязательно. Главное: каждый день живой рабочий прогресс.
          </p>
        </section>
